...
// Throws on non-2xx. Caller is responsible for typing the error (v0.6
// promotes 403s to TokenExpiredError etc.). A hard timeout (default 15s)
// prevents stalled fetches from leaking inFlightParses keys in the SW.
