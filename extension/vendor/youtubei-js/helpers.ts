 ...
 *
 * vdl-patch: explicit `return undefined` at function end to satisfy
 * our tsconfig's `noImplicitReturns`. Upstream relies on implicit
 * undefined — behavior is identical.
 */
